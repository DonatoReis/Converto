...
const MessageInput = ({ onSendMessage, selectedContact, darkMode = false }) => {
  ...
  // Component render
  return (
    <div className={`border-t ${darkMode ? 'border-gray-800 bg-neutral-900' : 'border-gray-200 bg-white'}`}>
      {showAudioPreview ? (
        // Audio preview UI
        <div className="p-3">
          <div className="flex flex-col rounded-lg p-3 bg-opacity-10 bg-gray-200">
            <div className="flex items-center justify-between mb-2">
              <div className="flex items-center">
                <div className="mr-2">
                  <svg xmlns="http://www.w3.org/2000/svg" className={`h-5 w-5 ${darkMode ? 'text-gray-300' : 'text-gray-700'}`} viewBox="0 0 20 20" fill="currentColor">
        ...
        >
          <div className="flex space-x-2">
            ...
            {message.trim() && (
              <button
                type="submit"
                className="bg-[#FF6700] text-white p-3 rounded-full hover:bg-[#FF6700]/90 transition-colors"
